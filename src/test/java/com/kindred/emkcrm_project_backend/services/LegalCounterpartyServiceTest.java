...
class LegalCounterpartyServiceTest {
    ...
    @BeforeEach
    void setUp() {
        service = new LegalCounterpartyService(counterpartyRepository, checkRepository, incidentRepository);
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken("lawyer", "pwd"));
    }
